...
<div class="catalogue_wrapper">
    <div class="catalogue_wrapper_left">
        <?php
            $image = !empty($row['image']) ? $objCatalogue->_path.$row['image']: 
        ...
        $category['id'];?>&amp;id=<?php echo $row['id']; ?>">
    ...
    <div class="catalogue_wrapper_right">
        <h4><a href="?page=catalogue-item&amp;category=<?php echo 
        $category['id'];?>&amp;id=<?php echo $row['id']; ?>">
        ...
        <p><?php echo Helper::shortenString(Helper::encodeHTML($row['description']), 150); ?></p>
